...
/**
 * REST controller for managing {@link com.srsco.expenseapp.domain.Expense}.
 */
@RestController
@RequestMapping("/api")
public class ExpenseResource {
     ...
     */
    @GetMapping("/total")
    public ResponseEntity<ExpenseTotalDTO> getExpenseToatl() {
        log.debug("REST request to get ExpenseTotal : {}");
        Optional<ExpenseTotalDTO> expenseTotalDTO = expenseService.findByDate();
        return ResponseUtil.wrapOrNotFound(expenseTotalDTO);
    }
}
